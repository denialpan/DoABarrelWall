...
I find myself fortunate that I was able to encounter a developer that open sourced their work heavily on Github. After sifting through their many repositories and reading through the code, I understood that tweak development is a skill in it by itself, that it is almost a stab in the dark given how little guides exist to get someone started. As far as I've understood, setting up the proper environment is simple enough, many guides exist for that purpose, but when it comes to  creating something unique, there is little to follow besides the official Apple Documentation page and third party page of nearly every single class dump provided.
