...
I find myself fortunate that I was able to encounter a developer that open sourced their work heavily on Github. After sifting through their many repositories and reading through the code, I understood that tweak development is a skill in it by itself, that it is almost a stab in the dark given how little guides exist to get someone started. Even now as far as I've understood, setting up the proper environment is simple enough to get started (many guides exist for that purpose), but when it comes to creating something unique, there is very little to follow besides the official [Apple Documentation](https://developer.apple.com/documentation/) and this third party [page](https://developer.limneos.net/) of nearly every single class dump available to modify, and maybe other smaller sites; but mostly the rest is up to the developer.
