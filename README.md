...
I have since permanently removed every single illegitimate copy of every tweak off my device in August of 2020 after realizing that tweak development isn't as simple as it is, and my mediocre opinion for tweak developers have been replaced with newfound respect. At this point I still haven't given tweak development a try myself, with the reasons aforementioned of believing it requires unbelievable amount of skill to become one, but I stayed long enough in the community to slowly understand what makes a tweak run, the processes behind, and the fundamentals of how it is constructed. 
...
Am I a tweak developer? No, absolutely not, I don't believe I am based off of this one tweak idea. That title belongs to those that put genuine effort into their work and have an interest in what they are doing instead of as a means to make easy money. Instead, I am more pleased that I have gained the valuable insight in what tweak developers have to go through, especially given my history of pirating and thinking literally the exact the opposite. 

While I may be done with tweak development likely forever, the journey most certainly hasn't left me with learning nothing. I have definitely expanded my own knowledge of programming, where I've touched up on interests of my own of optimization methods, file pointers, and how iOS generally works, and this I feel is essential as a way for me to apply what I've learned into career paths I plan to go into. None of this wouldn't have been possible without these circumstances of meeting any of the people above. This journey to end up with this project has been quite an experience that I don't regret at all. What I have learned from each and every one of the people above is beyond invaluable to me and means the world to me and I'm incredibly grateful for the amazing people that I was able to interact with, all of them are truly the best. I'll still be around to see what's new in the community, that's something I don't want to miss. But I do want to end this off with a statement that you've heard me say so many times.
