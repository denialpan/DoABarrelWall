...
- [**Litten**](https://twitter.com/schneelittchen) for inadvertently telling me that tweak development in Windows 10 is possible, therefore starting this whole adventure to creating this project. Even though I read over the basic syntax of obj-c, I find that being able to refer to her many open source of works that I personally use on a daily basis and receiving detailed explanations and suggestions from her proved to be the best resource possible. Her support every step of the way, all the way to the end to me finally creating the repository to host my tweak is invaluable, so I wholeheartedly need to express my thanks there.
